...
Android / iOS (separate repo, full on-device app like desktop — WebView fetch): [LOGA3-Automation-Mobile](https://github.com/fr4iser90/LOGA3-Automation-Mobile) — see [docs/MOBILE.md](docs/MOBILE.md).
